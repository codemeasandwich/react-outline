...
exports.default = function (_ref) {
  ...
  return function (props) {
    ...
    if ("css" in props) {
      ...
      _utils.classes.publish(randomClassName, (0, _utils.genCss)({ randomClassName: randomClassName, css: updatedCss, styleCSS: styleCSS, colors: colors, style: style, styleName: styleName }));
    }
