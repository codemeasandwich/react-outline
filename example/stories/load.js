...
import sourceCss7 from 'raw-loader!./CSSHelpers/StylesWithDynamicFn.js?sourceMap';
import Css7 from './CSSHelpers/StylesWithDynamicFn';
...
const tree = {
  ...
  "CSS Helpers": [
    ...
    {
      title: 'Styles With Dynamic Function',
      info: 'Click to toggle dynamic style. Resize below 600px to see media query.',
      source: sourceCss7, element: Css7,
      options: { propTables: false, source: false }
    }
  ]
